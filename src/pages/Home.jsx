...
export default ({data}) => {
    return <>
        ...
        <div className="block one">
                <a href="" className="description one-block">
                    <div>
                ...
                <a href="" className="description two-block">
                    <div>
                        <h3>Микс масел</h3>
            ...
            <div className="block two">
                <a href="" className="description three-block">
                    <div>
                ...
                <a href="" className="description four-block">
                    <div>
                ...
                <a href="" className="block five-block">
                    <div>
